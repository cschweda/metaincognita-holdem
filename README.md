...
**A note on the online poker era:** Some of the sites listed above -- particularly Full Tilt Poker and PokerStars -- became deeply controversial. Full Tilt was shut down for defrauding players, and the entire online poker landscape was upended by Black Friday (April 15, 2011) when the DOJ seized the domains of the three largest poker sites. That era is complicated, and the controversies are real. But before all of that, these sites and the communities around them were where millions of people learned to play poker. They shaped how we think about hand ranges, position, pot odds, and player types. This project draws on the *poker knowledge* that came out of that era -- the strategy, the formats, the analytical tools -- not the business practices. The pre-Black Friday online poker world no longer exists, or exists in a completely different form, but its influence on poker education is undeniable.
