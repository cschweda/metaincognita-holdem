...
### Documentation
- README: Preflop/Postflop Decision Flow sections updated for the short-stack, re-raise-size and blind-defense changes above; the Exploit Probe section's results table refreshed to this round's own 8 seeds × 30,000-hand protocol, and a new Composite Probe section added with the per-cell before/after table. Security → Audit Log gained a Round 8 entry. Test counts refreshed: 983 tests / 43 files → 1067 tests / 51 files.
